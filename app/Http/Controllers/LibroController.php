...
class LibroController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Verificar si el tipo de libro ha cambiado a "digital, fisico o externo"
        ...
        if ($request->has('tipo') && $request->tipo === 'fisico') {
            $libro->url = null;
            $libro->save();
        }
        ...
        if ($request->has('tipo') && ($request->tipo === 'externo' || $request->tipo === 'fisico')) {
            if ($libro->documento) {
